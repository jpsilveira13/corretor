    ...
    <div class="col-md-12">
        <div class="row">
            <div class="cadastro-form">
                ...
                <br />
                <form method="post" action="{{route('salvar.cidade')}}" class="form-horizontal form-simples">
                    {{ csrf_field() }}
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('estado_id') ? ' has-error' : '' }}">
                            <label class="col-sm-2 col-md-4 control-label">Estado</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('nome') ? ' has-error' : '' }}">
                            <label class="col-sm-1 col-md-2 control-label">Cidade</label>
